  ...
  flex-col ${styles.paddingY}`}>
     ...
     px-4 bg-discount-gradient rounded-[10px] mb-2">
      <img src={discount} alt="discount"
        ...
        <span className="text-white mr-2 ml-2">FIRST</span>
        |
        <span className="text-white mr-2 ml-2">MOST</span>
        |
        <span className="text-white mr-2 ml-2">HIGHEST</span>
        </p> 
     </div>
    <div className="flex flex-row justify-between items-center w-full">
       ...
       Focus on <br className="sm:block
        hidden"/> {" "}
        <span className='text-gradient'>High-Value
        </span>{" "}
         </h1>
    ...
    <h1 className="font-poppins font-semibold ss:text-[68px]
     text-[52px] text-white ss:leading-[100.8px]
      leading-[75px] w-full">
          Customers
       </h1>
